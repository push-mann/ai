...
final class MovieTest extends TestCase
{
    ...
    public function testFromFileParsesCloudAtlasFixture(): void
    {
    ...
    public function testFromFileParsesMatrixFixture(): void
    {
    ...
    public function testFromFileWithMinimalMarkdownLeavesOptionalFieldsNull(): void
    {
    ...
    public function testFromFileExposesRawMarkdown(): void
    {
        $movie = Movie::fromFile(self::FIXTURES_DIR.'/cloud-atlas.md');
