...
final class MovieRepositoryTest extends TestCase
{
    ...
    public function testAllReturnsMoviesSortedByFilename(): void
    {
    ...
    public function testFindReturnsMovieWhenFilePresent(): void
    {
        $repository = new MovieRepository($this->directory);
    ...
    public function testFindRejectsEmptyAndTraversalSlugs(): void
    {
        $repository = new MovieRepository($this->directory);
